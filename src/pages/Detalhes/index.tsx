			...
			<div className="max-w-full">
				{!dados ? (
					...
					<div className="space-y-6">
							...
							<div className="xl:col-span-1">
								<div className="bg-card border border-border rounded-2xl p-4 shadow-sm">
									<ImagemComFallback
										...
										alt={nome || ""}
										destaqueStatus={ultimaOcorrencia?.encontradoVivo ? "Vivo" : "Morto"}
										className="w-full h-[300px] xl:h-[400px] object-cover rounded-xl"
									/>
									<div className="mt-4 text-center">
										<span
											className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${ultimaOcorrencia?.encontradoVivo
													? "bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400"
													: "bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400"
												}`}
										>
											<div className={`w-2 h-2 rounded-full mr-2 ${ultimaOcorrencia?.encontradoVivo ? "bg-green-500" : "bg-red-500"}`}></div>
											{ultimaOcorrencia?.encontradoVivo ? "Localizado(a)" : "Desaparecido(a)"}
										</span>
									</div>
								</div>
							</div>
						...
						<div className="bg-card border border-border rounded-2xl p-4 shadow-sm">
							{ultimaOcorrencia?.encontradoVivo == true ? (
								...
								<div className="text-center">
									<div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-4">
										...
										<p className="text-red-700 dark:text-red-300 text-sm">
											A pessoa ainda não foi encontrada.
										</p>
									</div>
								</div>
							)}
